...
namespace ILSLib
{
	...
	const std::set<MouseButton::Button>& MouseListener::getButtonsTrigger() const
	{
	...
	bool MouseListener::triggersOnButtonAction() const
	{
		if(typeTrigger == MouseEvent::Type::Press ||
			typeTrigger == MouseEvent::Type::Release ||
			typeTrigger == MouseEvent::Type::Click ||
			typeTrigger == MouseEvent::Type::DoubleClickPress ||
			typeTrigger == MouseEvent::Type::DoubleClickRelease)
			return true;
	...
	void MouseListener::setButtonsTrigger(const std::set<MouseButton::Button>& buttons)
	{
