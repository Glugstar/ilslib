...
namespace ILSLib
{
	...
	*//*------------------------------------------------------------------------------*/
	struct Settings
	{
		...
		/*! @brief Element iteration mode for skipping certain elements */
		enum class IterationMode
		{
			All,
			Physical, // that occupy space (pre display area calculations)
			SuperPhysical, // that occupy space (post display area calculations)
			Visible, // that are visible (pre display area calculations)
			SuperVisible // that are visible (post display area calculations)
		};
