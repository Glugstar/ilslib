...
namespace ILSLib
{
	...
	*//*------------------------------------------------------------------------------*/
	...
	public:
		...
		virtual const std::list<std::string>& getKeyCodesTrigger() const;
		...
		virtual void setKeyCodesTrigger(const std::list<std::string>& keyCodes);
	protected:
		KeyboardEvent::Type typeTrigger;
		std::list<std::string> keyCodesTrigger;
	};
