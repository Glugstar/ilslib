...
namespace ILSLib
{
	...
	*//*------------------------------------------------------------------------------*/
	...
	public:
		...
		virtual const std::list<MouseButton::Button>& getButtonsTrigger() const;
		...
		virtual void setButtonsTrigger(const std::list<MouseButton::Button>& buttons);
	protected:
		MouseEvent::Type typeTrigger;
		std::list<MouseButton::Button> buttonsTrigger;
	};
